...
@section('content')
    ...
    <form action="{{ route('courses.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                   placeholder="Course Name (minimum 10 char)"
                   value="{{ old('name') }}" minlength="10" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="instructor" id="instructor" class="form-control @error('instructor') is-invalid @enderror"
                   placeholder="Instructor Name (minimum 3 char, no special characters)"
                   value="{{ old('instructor') }}" minlength="3" required> 
        ...
        <div class="mb-3">
            ...
            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                      rows="3" minlength="30" placeholder="Course Description (minimum 30 char)" required>{{ old('description') }}</textarea>
    ...
    <script>
        // Real-time validation for Courses Create Form
